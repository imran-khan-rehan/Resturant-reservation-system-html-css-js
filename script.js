...
function initNavigation() {
    document.querySelectorAll('nav a').forEach(link => {
        link.addEventListener('click', (e) => {
            ...
            let sectionId;
            const iconClass = e.target.querySelector('i').classList;
            
            if (iconClass.contains('fa-home')) sectionId = 'home';
            else if (iconClass.contains('fa-store')) sectionId = 'restaurants';
            else if (iconClass.contains('fa-door-open')) sectionId = 'rooms';
            else if (iconClass.contains('fa-calendar-alt')) sectionId = 'reservations';
